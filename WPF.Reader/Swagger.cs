...
//----------------------
// <auto-generated>
//     Generated REST API Client Code Generator v1.6.97.0 on 17/02/2023 08:42:43
...
namespace WPF.Reader.Api
{
    ...
    public interface IBookApiSync : IApiAccessor
    {
        ...
        List<Book> BookGetBooks(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<Book>> BookGetBooksWithHttpInfo(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0);
    ...
    public interface IBookApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Book>> BookGetBooksAsync(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Book>>> BookGetBooksWithHttpInfoAsync(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BookApi : IBookApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;Book&gt;</returns>
        public List<Book> BookGetBooks(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0)
        {
            WPF.Reader.Client.ApiResponse<List<Book>> localVarResponse = BookGetBooksWithHttpInfo(offset, limit, genre);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Book&gt;</returns>
        public WPF.Reader.Client.ApiResponse<List<Book>> BookGetBooksWithHttpInfo(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0)
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Book&gt;</returns>
        public async System.Threading.Tasks.Task<List<Book>> BookGetBooksAsync(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.ApiResponse<List<Book>> localVarResponse = await BookGetBooksWithHttpInfoAsync(offset, limit, genre, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Book&gt;)</returns>
        public async System.Threading.Tasks.Task<WPF.Reader.Client.ApiResponse<List<Book>>> BookGetBooksWithHttpInfoAsync(int? offset = default(int?), int? limit = default(int?), int? genre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
...
namespace WPF.Reader.Model
{
    ...
    public partial class Book : IEquatable<Book>, IValidatableObject
    {
        ...
        public Book(int id = default(int), string nom = default(string), string auteur = default(string), int prix = default(int), string contenu = default(string), List<Genre> genres = default(List<Genre>))
        {
            this.Id = id;
            this.Prix = prix;
            this.Nom = nom;
...
namespace WPF.Reader.Model
{
    ...
    public partial class Genre : IEquatable<Genre>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="genreLitteraire">genreLitteraire.</param>
        public Genre(int id = default(int), string genreLitteraire = default(string))
        {
            this.Id = id;
        ...
        public int Id { get; set; }
        /// <summary>
        /// Gets or Sets GenreLitteraire
        /// </summary>
        [DataMember(Name = "genreLitteraire", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  GenreLitteraire: ").Append(GenreLitteraire).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        /// <summary>
        ...
        public bool Equals(Genre input)
        {
            ...
            return 
                ...
                (
                    this.GenreLitteraire == input.GenreLitteraire ||
                    (this.GenreLitteraire != null &&
                    this.GenreLitteraire.Equals(input.GenreLitteraire))
                );
        }
        /// <summary>
        /// Gets the hash code
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.Id.GetHashCode();
                if (this.GenreLitteraire != null)
                {
                    hashCode = (hashCode * 59) + this.GenreLitteraire.GetHashCode();
                }
                return hashCode;
            }
        }
